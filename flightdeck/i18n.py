...
CATALOG = {
    ...
    'Flightdeck konnte nicht neu geöffnet werden. Bitte beende Spiel und Einrichtung und versuche es erneut.': 'Could not reopen Flightdeck. Close the game and finish setup, then try again.',
    'GitHub meldet eine ungültige Flightdeck-Version.': 'GitHub returned an invalid Flightdeck version.',
    'Der Update-Download wurde an eine unbekannte Adresse umgeleitet.': 'The update download was redirected to an unknown address.',
    'Ungültige GitHub-Downloadadresse.': 'Invalid GitHub download address.',
    'GitHub meldet keine veröffentlichte Flightdeck-Version.': 'GitHub did not return a published Flightdeck release.',
    'Das vollständige Linux-Updatepaket fehlt in diesem Release.': 'This release is missing the complete Linux update package.',
    'Das GitHub-Updatepaket hat keine gültigen Prüfdaten.': 'The GitHub update package has no valid verification data.',
    'Die GitHub-Antwort ist zu groß.': 'The GitHub response is too large.',
    'Die GitHub-Antwort konnte nicht gelesen werden.': 'Could not read the GitHub response.',
    'Die Größe des Updatepakets stimmt nicht mit GitHub überein.': 'The update package size does not match GitHub.',
    'Die Prüfsumme des Updates stimmt nicht. Bitte erneut herunterladen.': 'The update checksum does not match. Download it again.',
    'Das Updatepaket enthält ungültige Dateien.': 'The update package contains invalid files.',
    'Das entpackte Updatepaket ist zu groß.': 'The unpacked update package is too large.',
    'Das Updatepaket ist unvollständig.': 'The update package is incomplete.',
    'Die Versionsangabe im Updatepaket fehlt.': 'The update package is missing its version.',
    'Die Version im Updatepaket stimmt nicht mit GitHub überein.': 'The version inside the update package does not match GitHub.',
    'Die installierte Flightdeck-Version konnte nicht zugeordnet werden.': 'Could not identify the installed Flightdeck release.',
    'Für Updates im Launcher Flightdeck einmal mit dem offiziellen Installer installieren.': 'To update from the launcher, install Flightdeck once with the official installer.',
    'Dieser Launcher-Updatevorgang ist gerade nicht verfügbar.': 'This launcher update action is not currently available.',
    'Bitte die Flightdeck-Updates zuerst erneut prüfen.': 'Check for Flightdeck updates again first.',
    'GitHub wird nach Flightdeck-Updates gefragt …': 'Checking GitHub for Flightdeck updates …',
    'Launcher-Update wird vorbereitet …': 'Preparing launcher update …',
    'Eine neue Flightdeck-Version ist verfügbar.': 'A new Flightdeck version is available.',
    'Flightdeck ist auf dem neuesten Stand.': 'Flightdeck is up to date.',
    ...
    'Vorherige Launcher-Version wird wiederhergestellt …': 'Restoring the previous launcher version …',
    'Flightdeck wird von GitHub heruntergeladen …': 'Downloading Flightdeck from GitHub …',
    'Updatepaket wird geprüft …': 'Verifying update package …',
    'Flightdeck wird aktualisiert …': 'Updating Flightdeck …',
    'Das Launcher-Update konnte nicht installiert werden. Die bisherige Version bleibt verfügbar.': 'Could not install the launcher update. The previous version remains available.',
    'Update installiert. Öffne Flightdeck jetzt neu.': 'Update installed. Reopen Flightdeck now.',
    'Vorherige Version bereit. Öffne Flightdeck jetzt neu.': 'Previous version ready. Reopen Flightdeck now.',
    'Launcher-Update abgebrochen.': 'Launcher update cancelled.',
    'GitHub ist gerade nicht verfügbar oder das Abfragelimit ist erreicht. Bitte später erneut versuchen.': 'GitHub is unavailable or its request limit has been reached. Try again later.',
    'GitHub ist nicht erreichbar. Prüfe deine Internetverbindung und versuche es erneut.': 'Cannot reach GitHub. Check your internet connection and try again.',
    'Das Launcher-Update ist fehlgeschlagen. Die bisherige Version bleibt verfügbar.': 'The launcher update failed. The previous version remains available.',
    'Dieser Launcher-Updatevorgang kann nicht mehr abgebrochen werden.': 'This launcher update can no longer be cancelled.',
    'Launcher-Update wird abgebrochen …': 'Cancelling launcher update …',
    'Bitte beende Spiel und Einrichtung vor dem Launcher-Neustart.': 'Close the game and finish setup before restarting the launcher.',
    'Der installierte Launcher wurde verändert. Bitte den Installer erneut ausführen.': 'The installed launcher was modified. Run the installer again.',
    ...
    'Fenix-Patch eingerichtet. Die nächsten Schritte stehen oben.': 'Fenix patch ready. The next steps are shown above.',
    ...
    'Deine Spielstände sind lokal gesichert. Versuche den Cloud-Upload erneut oder spiele mit lokalen Spielständen weiter. Der ausstehende Abgleich bleibt erhalten.': 'Your saves are backed up locally. Retry the upload or keep playing with local saves. The pending sync is preserved.',
    'Die Xbox-Cloud ist gerade nicht erreichbar. Versuche es erneut oder spiele mit lokalen Spielständen weiter.': 'Xbox cloud storage is currently unreachable. Retry or keep playing with local saves.',
